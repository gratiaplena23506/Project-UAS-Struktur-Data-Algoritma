...
#Fungsi ini mengimplementasikan Algoritma Dijkstra untuk mencari rute terpendek dari titik awal ke titik tujuan berdasarkan bobot graf yang diberikan.  
# Proses utama:
# 1. Inisialisasi jarak ke semua simpul dengan nilai tak hingga (infinity).
# 2. Menggunakan Priority Queue (heapq) untuk memprioritaskan simpul dengan jarak akumulasi terkecil agar pencarian efisien secara komputasi
# 3. Melakukan iterasi (relaksasi) pada tetangga simpul untuk menemukan jarak minimum.
...
#Fungsi utilitas untuk menjumlahkan bobot total dari sebuah lintasan (path)berdasarkan kamus graf sumber yang ditentukan (jarak atau waktu).
...
## Inisialisasi antarmuka pengguna dan pengaturan layout jendela aplikasi
class AppVisualisasiDijkstra:
    ...
    #Fungsi untuk memetakan visualisasi graf ke kanvas Matplotlib.
    #Fungsi ini menangani penggambaran garis panah antar simpul dan pemberian label nama jalan serta jarak secara otomatis pada peta.
    ...
    # Fungsi pengendali utama (Controller) yang menghubungkan input pengguna dengan logika algoritma.
        #Alur kerja:
        #1. Validasi input simpul awal dan tujuan dari antarmuka.
        #2. Menjalankan fungsi dijkstra untuk skenario 'Waktu' dan 'Jarak'.
        #3. Memperbarui label informasi pada aplikasi.
        #4. Melakukan rendering ulang pada kanvas grafik untuk menampilkan hasil rute
